<div class="main-menu">
	<header class="header">
		<a href="index-2.html" class="logo"><img class="img-fluid" src="images/logo.png" alt="Logo"></a>
	...
	<div class="content">
		...
		<div class="navigation">
			<ul class="menu js__accordion">
                ...
                <li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon mdi mdi-cube-outline"></i><span>Update Profile</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="ui-notification.html">Edit Profile</a></li>
						<li><a href="profile.html">Delete Profile</a></li>
						<li><a href="ui-range-slider.html">View Profile</a></li>
					</ul>
