...
<!-- Mirrored from demo.ninjateam.org/html/zeiss/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2020 10:25:26 GMT -->
<head>
	...
	<div class="content">
		...
		<div class="navigation">
			<ul class="menu js__accordion">
				<li class="current">
					<a class="waves-effect" href="/employer"><i class="menu-icon mdi mdi-view-dashboard"></i><span>Dashboard</span></a>
				</li>
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon fas fa-user"></i><span>Company Profile</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="/employer/create">Update Company Profile</a></li>
						<li><a href="/employer/show">View Company Profile</a></li>
					</ul>
					<!-- /.sub-menu js__content -->
				</li>
				
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon mdi mdi-group"></i><span>Jobs</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="/job/create">Post New Job</a></li>
						<li><a href="/job/show">All Posted Jobs</a></li>
...
<div class="fixed-navbar">
	...
	<div class="float-right">
		...
		<div class="ico-item">
			<img src="{{asset('assets/images/avatar-sm-1.jpg')}}" alt="" class="ico-img">
			<ul class="sub-ico-item">
				<li><a href="#">Settings</a></li>
				<li><a href="#">Blog</a></li>
				<li><a class="js__logout" href="{{ route('logout') }}"
...
<!-- Google Chart -->
<script type="{{asset('text/javascript" src="../../../../www.gstatic.com/charts/loader.js')}}"></script>
...
<!-- Mirrored from demo.ninjateam.org/html/zeiss/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2020 10:26:13 GMT -->
</html>