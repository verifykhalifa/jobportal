	...
	<div class="content">
		...
		<div class="navigation">
			<ul class="menu js__accordion">
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon fas fa-user"></i><span>Profile</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="/superadmin/create">Update Profile</a></li>
						<li><a href="/superadmin/show">View Profile</a></li>
					</ul>
					<!-- /.sub-menu js__content -->
				</li>
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon mdi mdi-group"></i><span>Manage Staff</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
						<li><a href="/staff/create">New Staff</a></li>
						<li><a href="/staff/show">View All Staff</a></li>
					</ul>
					<!-- /.sub-menu js__content -->
				</li>
				<li>
