                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                @elseif(Auth::user()->role == 'employee')
                                    <a href="/employee" ><span style="margin-left: 20px;">Profile</span></a>
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="tr-sidebar">
                            <ul class="nav nav-tabs profile-tabs section" role="tablist">
                                <li role="presentation"><a href="/employee" ><i class="fa fa-life-ring" aria-hidden="true"></i> Account Info</a></li>
                                <li role="presentation"><a href="/employee/show" ><span><i class="fa fa-user-o" aria-hidden="true"></i></span> My Resume</a></li>
                            <li role="presentation"><a href="/employee/{{$realid}}/edit" ><span><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span> Edit Resume</a></li>
                                <li role="presentation"><a href="/employee/bookmark" ><span><i class="fa fa-bookmark-o" aria-hidden="true"></i></span> Bookmark</a></li>
                                <li role="presentation"><a href="/employee/applyjob" ><span><i class="fa fa-clone" aria-hidden="true"></i></span> Archived Apply Job</a></li>
                                <li role="presentation"><a href="/employee/closeaccount" ><span><i class="fa fa-scissors" aria-hidden="true"></i></span> Close Account</a></li>
                            </ul>	
