...
<div class="main-menu">
	<header class="header">
		<a href="index-2.html" class="logo">Zeiss</a>
	...
	<div class="content">
		...
		<div class="navigation">
			<ul class="menu js__accordion">
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon mdi mdi-flower"></i><span>Update Profile</span><span class="menu-arrow fa fa-angle-down"></span></a>
